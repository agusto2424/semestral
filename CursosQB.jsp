...
<html>
  ...
  <title>Resultados</title>
    ...
    <body>
        ...
        <section>
            <% String nombre = request.getParameter("nombreqb");%>
            <% String cedula = request.getParameter("cedulaqb");%>
            <% String edad = request.getParameter("edadqb");%>
            <% String fecha = request.getParameter("fechaqb");%>
...
<%
   try {
      ...
      String insertarsql = "INSERT INTO biologia (nombre, cedula, edad, fecha) VALUES ('" +nombre+ "', '" + cedula + "','" + edad + "','" + fecha + "')";
