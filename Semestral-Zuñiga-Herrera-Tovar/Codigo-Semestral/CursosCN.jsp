...
<html>
  ...
  <title>resultados</title>
    ...
    <body>
        ...
        <a href="Inicio.html" class="botonenlace">REGRESAR A INICIO</a>
      </div>
        <section>
            <% String nombre = request.getParameter("nombrecn");%>
            <% String cedula = request.getParameter("cedulacn");%>
            <% String edad = request.getParameter("edadcn");%>
            <% String fecha = request.getParameter("fechacn");%>
...
<%
   try {
      ...
      String insertarsql = "INSERT INTO ciencias (nombre, cedula, edad, fecha) VALUES ('" +nombre+ "', '" + cedula + "','" + edad + "','" + fecha + "')";
